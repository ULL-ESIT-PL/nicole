#include "../../../../inc/tables/typeTable/typeValidators/intValidator.h"

namespace nicole {

std::shared_ptr<Type>
IntValidator::isAssignable(const std::shared_ptr<Type> &type) const noexcept {
...
std::shared_ptr<Type>
IntValidator::isConvertible(const std::shared_ptr<Type> &) const noexcept {
  return nullptr;
}

std::shared_ptr<Type> IntValidator::isOperable(const std::shared_ptr<Type> &,
