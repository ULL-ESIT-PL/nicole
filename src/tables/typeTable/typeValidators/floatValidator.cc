#include "../../../../inc/tables/typeTable/typeValidators/floatValidator.h"

namespace nicole {

std::shared_ptr<Type>
FloatValidator::isAssignable(const std::shared_ptr<Type> &type) const noexcept {
...
std::shared_ptr<Type>
FloatValidator::isConvertible(const std::shared_ptr<Type> &) const noexcept {
  return nullptr;
}

std::shared_ptr<Type> FloatValidator::isOperable(const std::shared_ptr<Type> &,
