#ifndef AST_BIGGER_EQUAL_H
#define AST_BIGGER_EQUAL_H
...
class AST_BIGGER_EQUAL : public AST {
private:
  Token op_;
...
public:
  explicit AST_BIGGER_EQUAL(const Token &op, const std::shared_ptr<AST> &left,
                   const std::shared_ptr<AST> &right,
                   const SourceLocation &sourceLocation) noexcept
      : AST(AST_TYPE::BIGGER_EQUAL, sourceLocation), op_{op}, left_{left},
        right_{right} {}
